...
import { Hand, Clock, Car, Users, ArrowRight } from 'lucide-react';
...
export function PassengerSearchScreen() {
  const { setState, availableRoutes, setSelectedRoute, user, setCurrentRide } = useApp();
    ...
    >
      <div className="px-2">
        ...
        <p className="text-on-surface-variant text-sm font-medium">
          현재 모집 중인 카풀 {availableRoutes.length}대
        </p>
      </div>
